    ...
    <div class="py-12 bg-gradient-to-br from-gray-50 via-indigo-50/20 to-purple-50/20 dark:from-gray-900 dark:via-gray-900 dark:to-gray-900 min-h-screen">
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="mb-6 text-center">
                <h1 class="text-3xl font-bold text-gray-900 dark:text-white mb-2">Create Your Service</h1>
                <p class="text-gray-600 dark:text-gray-400">Showcase your skills and attract clients</p>
            </div>
                    ...
                    <form method="POST" action="{{ route('services.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="mb-8">
                            ...
                            <div class="mb-6">
                                ...
                                <x-text-input id="title" class="block mt-2 w-full text-lg" type="text" name="title" :value="old('title')" required autofocus placeholder="e.g., Professional Logo Design" />
                        ...
                        <div class="mb-8">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div>
                                    ...
                                    <select id="pricing_type" name="pricing_type" class="mt-2 block w-full border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-xl shadow-sm text-base" required>
                                        <option value="fixed" {{ old('pricing_type', 'fixed') == 'fixed' ? 'selected' : '' }}>Fixed - One-time price</option>
                                        <option value="hourly" {{ old('pricing_type') == 'hourly' ? 'selected' : '' }}>Hourly - Price per hour</option>
                                        <option value="project" {{ old('pricing_type') == 'project' ? 'selected' : '' }}>Project - Price per milestone</option>
                                    </select>
                            ...
                            <div class="mt-6">
                                ...
                                <select id="category_select" class="mt-2 block w-full border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-xl shadow-sm text-base" onchange="toggleCategoryInput()" required>
                                    ...
                                    <option value="Others" {{ old('category') && !in_array(old('category'), ['Web Development', 'Mobile Development', 'Graphic Design', 'UI/UX Design', 'Content Writing', 'Digital Marketing', 'Video Editing', 'Data Entry', 'Virtual Assistant']) ? 'selected' : '' }}>Others</option>
                                </select>
                                <input type="text" id="category_input" name="category" class="hidden mt-2 block w-full border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-xl shadow-sm text-base" placeholder="Enter custom category" value="{{ old('category') }}" />
                        ...
                        <div class="mb-8">
                            ...
                            <div>
                                ...
                                <option value="published" {{ old('status') == 'published' ? 'selected' : '' }}>Published - Visible to clients</option>
                                <option value="archived" {{ old('status') == 'archived' ? 'selected' : '' }}>Archived - Hidden from clients</option>
                                </select>
                                <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">Choose "Published" to make your service visible to clients immediately</p>
